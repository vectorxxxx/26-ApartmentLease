...
public class RoomController
{
    ...
    public Result<RoomDetailVo> getDetailById(
            @RequestParam
                    Long id) {
    ...
    public Result updateReleaseStatusById(Long id, ReleaseStatus status) {
        service.update(new LambdaUpdateWrapper<RoomInfo>()
    ...
    public Result<List<RoomInfo>> listBasicByApartmentId(Long id) {
        List<RoomInfo> roomInfoList = service.list(new LambdaQueryWrapper<RoomInfo>()
