...
public class ApartmentController
{
    ...
    public Result saveOrUpdate(
            @RequestBody
                    ApartmentSubmitVo apartmentSubmitVo) {
    ...
    public Result<IPage<ApartmentItemVo>> pageItem(
            @RequestParam
                    long current,
            @RequestParam
                    long size, ApartmentQueryVo queryVo) {
    ...
    public Result<ApartmentDetailVo> getDetailById(
            @RequestParam
                    Long id) {
    ...
    public Result updateReleaseStatusById(
        ...
        service.update(new LambdaUpdateWrapper<ApartmentInfo>()
    ...
    public Result<List<ApartmentInfo>> listInfoByDistrictId(
            @RequestParam
                    Long id) {
        List<ApartmentInfo> list = service.list(new LambdaQueryWrapper<ApartmentInfo>().eq(ApartmentInfo::getDistrictId, id));
        return Result.ok(list);
    }
}
